 ...
 * vorahost:~ 
         spark-submit --jars /opt/vora/lib/vora-spark/lib/spark-sap-datasources-1.4.2.20-vora-1.4-assembly.jar
                      --jars ./spark-csv_2.10-1.1.0.jar
                      --jars ./commons-csv-1.1.jar
                      --packages com.databricks:spark-csv_2.10:1.1.0 
                      --class com.vora.mlearning.KMeansDemoVoraHost vorademo.jar 
 * @author Yanbing
 */
public class KMeansDemoVoraHost {
	public static void main(String[] args) {
		SparkConf conf = new SparkConf()
				.setAppName("KMeansDemoVoraHost")
		...
		options.put("path", "/usr/vora/kmeans_input_data.csv");
		...
		DataFrame salesCaseDF = sqlContext.read()
			    ...
			    .option("header", "true")
			    .option("charset", "UTF8")
			    .load("/usr/vora/kmeans_input_data.csv");
